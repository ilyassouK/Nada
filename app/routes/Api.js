...
router.post('/v1/products/path5', adminToken, deleteTracked);
...
router.get('/v1/products/path9', managersToken, getUsersAndClientsOfItems, nextDbProccess);
router.post('/v1/products/path10', adminToken, addProductStatus);
router.get('/v1/products/path11', verifyToken, fetchProductsStatus, nextDbProccess);
router.post('/v1/products/path12', adminToken, deleteStatus);
// ==================================================================================
